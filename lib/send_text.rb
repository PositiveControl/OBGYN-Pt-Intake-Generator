class TextMessage
  ...
  def text_message(message)
    ...
    login_req.form_data = {'accountType' => 'GOOGLE', 'Email' => 'twenty4play@gmail.com', 'Passwd' => '*******', 'service' => 'grandcentral', 'source' => 'tiare.herokuapp.com'}
    ...
    req.form_data = {'id' => '', 'phoneNumber' => '*********', 'text' => message, '_rnr_se' => 'BJQn6mVVF+L/PIvaPaaBWpGXTBY='}
